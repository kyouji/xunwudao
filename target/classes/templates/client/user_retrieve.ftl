  ...
  <article class="login-form">
    <form>
      <section class="enter-info">
        ...
        <!-- 获取验证码 -->
        <a class="get-code" style="  top: 38%;" id="smsCodeBtn" href="javascript:void(0)">获取短信验证码</a>
        <input class="password" id="txt_regMcode" type="tel" placeholder="请输入收到的短信验证码">
        <input class="password" id="txt_regPassword" type="password" placeholder="请输入6-16位新密码">
