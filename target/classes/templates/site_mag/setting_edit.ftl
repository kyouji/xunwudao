...
$(function () {
    <#if status??>
        var dialog =  $.dialog.alert("修改系统配置成功");
    </#if>
    ...
    $(".upload-img").each(function () {
        $(this).InitSWFUpload({ 
        	filetypes:"*.jpg;*.jpge;*.png;*.gif;*.doc;*.docx;*.xls;*.xlsx;*.ppt;*.pptx;*.pdf;*.rar;*.zip;*.txt;*.mp4;*.mht;*.mhtml;*.apk;",
...
<div class="tab-content" style="display: block;">
    ...
    <dl>
        <dt>安卓App</dt>
        <dd>
            <input id="ImgUrl" name="androidDownload" type="text" datatype="*0-255" value="<#if setting??>${setting.androidDownload!""}</#if>" class="input normal upload-path">
            <div class="upload-box upload-img"></div>
            <span class="Validform_checktip"></span>
        </dd>
    </dl>
...
<div class="tab-content" style="display: none;">
   <dl>
        <dt>上一级分享奖励积分</dt>
        <dd>
            <input name="registerSuccessPoints" type="text" value="<#if setting??>${setting.registerSuccessPoints!"20"}<#else>20</#if>" class="input" datatype="n" sucmsg=" ">%
            <span class="Validform_checktip"></span>
        </dd>
    </dl>
    <dl>
        <dt>上两级分享奖励积分</dt>
        <dd>
            <input name="registerSharePoints" type="text" value="<#if setting??>${setting.registerSharePoints!"10"}<#else>10</#if>" class="input" datatype="n" sucmsg=" ">%
            <span class="Validform_checktip"></span>
        </dd>
    </dl>
     <#--
