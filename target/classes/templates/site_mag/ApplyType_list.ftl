...
<body class="mainbody">
<form name="form1" method="post" action="/Verwalter/setting/applyType/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/Verwalter/setting/applyType/edit"><i></i><span>新增</span></a></li>
    ...
    <#if applyType_list??>
        <#list applyType_list as item>
            <tr>
                ...
                <td align="center">
                    <a href="/Verwalter/setting/applyType/edit?id=${item.id}">修改</a>
                </td>
              </tr>
        </#list>
    </#if>
