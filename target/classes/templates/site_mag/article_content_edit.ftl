...
<input name="categoryId" type="text" value='${categoryId!""}' style="display:none">
...
<input name="id" type="text" value='<#if article??>${article.id?c!""}</#if>' style="display:none">
    <!--导航栏-->
    <div class="location">
        <a href="/Verwalter/content/list/${categoryId!''}?cid=${cid!""}&mid=${mid!""}" class="back"><i></i><span>
            返回列表页</span></a> 
        ...
        <div id="floatHead" class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    ...
                    <#--"荣誉照片墙"><li><a href="javascript:;" onclick="tabs(this);" class="">详细描述</a></li>-->
