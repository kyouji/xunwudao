...
<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		<#if newApply?? && newApply gt 0>
        	$("#new-apply").addClass("new_apply");
        	$("#new-apply").html(${newApply!''});
		</#if>
         ...
         $.ajax({
                ...
                success: function (data) {   
                     if (data.code == 0) {
                        ...
                        //意见或建议
                         if(data.apply>applynumber && applynumber !=0){
                            var dialog = $.dialog.alert("有新的留言！");
                        }
                        applynumber = data.apply;
                        if(data.newApply > 0)
                        {
                        	$("#new-apply").addClass("new_apply");
                        	$("#new-apply").html(data.newApply);
                        }
                    ...
                    <#list root_menu_list as menu>
                        ...
                        <#elseif menu_index == 5>
                        	<li class="">
	                        	...
	                        	<b id="new-apply"<#if newapply?? && newapply gt 0>class="new_apply"</#if>>
	                        	${newapply!''}
	                        	</b>
	                        	</span>
                        	</li>    
