    ...
    <div id="id-first-tab" class="tab-content" style="display: block;">
        ...
        <dl>
            ...
            <dd>
                ...
                <span class="Validform_checktip">虚拟价格</span>
            </dd>
        </dl>
        <dl>
            <dt>销售价</dt>
            <dd>
                ...
                <span class="Validform_checktip">*实际价格</span>
            </dd>
        </dl>
        <dl>
            <dt>销量</dt>
        ...
        <#if diysite_list??>
            <dl>  
                  <dt><b>参与门店</b></dt>
                  <span style="margin-left: 8px;height: 20px; overflow: hidden;color: #999;font-size: 12px">数量为0表示不参与</span>
            </dl>
            <#list diysite_list as item>
              <dl>  
                    <dt>&nbsp;&nbsp;&nbsp;${item.title!''}</dt>
                    <dd>
                        <input name="diysiteleftNumbers" type="text" value="<#if diysiteLeftnumber_list?? && diysiteLeftnumber_list[item_index]?? >${diysiteLeftnumber_list[item_index].leftNumber!'10'}<#else>10</#if>" class="input small" datatype="n" sucmsg=" ">
