...
<form name="form1" method="post" action="/Verwalter/bill/finance/list" id="form1">
<div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  ...
  <tr class="odd_bg">
    ...
    <#if finance_page??>
        <#list finance_page.content as item>
            <tr>
                <td align="center">
                ...
                <td align="center">
                    <a href="/Verwalter/bill/finance/edit/${item.id}?time=${time!''}">详情</a>
                </td>    
              </tr>
        </#list>
    </#if>
