...
@Configuration
@ComponentScan(basePackages={"com.ynyes.xunwudao"})
@EnableAutoConfiguration
public class XunwudaoApplication extends SpringBootServletInitializer implements CommandLineRunner {
    @Autowired
    ...
    public static void main(String[] args) {
        SpringApplication.run(XunwudaoApplication.class, args);
    }
