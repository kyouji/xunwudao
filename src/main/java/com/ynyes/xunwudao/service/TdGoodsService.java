...
import com.ynyes.xunwudao.repository.TdGoodsRepo;
...
public class TdGoodsService {
    ...
    public List<TdGoods> findByCategoryIdAndParamValueCollectContainingAndIsOnSaleTrueOrderBySortIdAsc(Long  categoryId, String paramValueCollect )
    {
		return repository.findByCategoryIdAndParamValueCollectContainingAndIsOnSaleTrueOrderBySortIdAsc(categoryId, paramValueCollect);
	}
    
    public List<TdGoods> findBycategoryIdTreeContainingAndIsOnSaleTrueOrderBySortIdAsc(Long catId)
    {
    	return repository.findBycategoryIdTreeContainingAndIsOnSaleTrueOrderBySortIdAsc(catId);
    }
    ...
    public List<TdGoods> findByCategoryIdAndIsOnSaleTrue(Long catId) {
        if (null == catId) {
            return null;
        }

        return repository.findByCategoryIdAndIsOnSaleTrue(catId);
    }
