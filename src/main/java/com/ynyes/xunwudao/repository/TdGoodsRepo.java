		...
		JpaSpecificationExecutor<TdGoods> 
{
	...
	List<TdGoods> findByCategoryIdAndIsOnSaleTrue(Long catId);
	...
	List<TdGoods> findByCategoryIdAndParamValueCollectContainingAndIsOnSaleTrueOrderBySortIdAsc(Long categoryId, String paramValueCollect);
	
    Page<TdGoods> findByCategoryIdTreeContainingAndIsOnSaleTrue(String categoryId, Pageable page);
    
    List<TdGoods> findBycategoryIdTreeContainingAndIsOnSaleTrueOrderBySortIdAsc(Long catId);
